...
const About = () => {
  ...
  return (
    <div ref={slideRef} className="slideRef max-w-full mx-auto transition-all duration-400 h-full bg-black text-gray-50 md:my-2 pb-24 md:pb-0">
      <motion.div
      ...
      <div className="w-full text-4xl md:text-5xl h-full md:px-2 px-6 flex items-center justify-center cursor-context-menu">
        <p className="w-[1000px] font-medium mt-24 md:mt-0">
          ...
          technology and problem-solving. I thrive on <span className="text-[#F59E0B] font-bold">learning new concepts</span>,
